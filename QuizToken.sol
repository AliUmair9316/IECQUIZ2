...
////////////////////////////State Variables//////////////////////////////////////////
    ...
    string public constant name = "DeeSoul";
...
/////////////////////////////Modifier/////////////////////////////////
    modifier onlyAdmin() {
        require(msg.sender == admin, "You can not perform this action");
        _;
    }
/////////////////////////////Main Functions/////////////////////////////////
    function buyTokens(uint256 _value) external payable returns (bool) {
        remainingTokens = remainingTokens - (VALUE * _value);
        require(remainingTokens > 0, "Token unavailable Right Now");
   ...
   require(msg.value >= firstMonthPrice * _value);
    ...
    function withdrawMoney() external onlyAdmin {
        require(
            ...
            "UnSufficient Money for withdrawl"
        );
